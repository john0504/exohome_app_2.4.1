      ...
      _device: {
        ...
        profile: {
          esh: {
            ...
            brand: this.params.get('brand') ? this.params.get('brand') : "hotachi", 
            model: this.params.get('model') ? this.params.get('model') : "type1-2"
          },
          module: {
            firmware_version: "0.6.3", 
            mac_address: this.params.get('serial') ? this.params.get('serial') : "test",
        ...
        properties: { displayName: this.params.get('serial') ? this.params.get('serial') : "test"},
        fields: [],
        status: {}
      },
      _deviceSn: "",
